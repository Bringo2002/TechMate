    ...
    <div className="min-h-screen bg-[#0A0E1A] text-white p-4 md:p-6 space-y-6">
          ...
          <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-6">
            <div className="flex-1 min-w-0">
              ...
              <div className="flex flex-wrap items-center gap-4 text-sm text-gray-400">
                ...
                <button onClick={() => navigate(`/dashboard/projects/${project.id}/team`)}
                  className="flex items-center gap-1.5 px-3 py-1 bg-purple-500/10 hover:bg-purple-500/20 border border-purple-500/30 rounded-lg text-purple-400 text-xs font-semibold transition-all">
      ...
      <div className="bg-gradient-to-br from-gray-900/90 to-gray-900/40 backdrop-blur-xl border border-gray-800/50 rounded-2xl p-5 sticky bottom-4 z-20 shadow-2xl shadow-black/50">
        <div className="flex flex-wrap gap-3 items-center">
          ...
          <button onClick={() => navigate(`/dashboard/projects/${project.id}/team`)}
            className="flex items-center gap-2 px-5 py-2.5 bg-purple-500/10 hover:bg-purple-500/20 border border-purple-500/30 text-purple-400 rounded-xl text-sm font-semibold transition-all">
